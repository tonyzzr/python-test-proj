...
# Compatibility: some older code (and skvideo) expects `np.float` alias which was removed in
# newer numpy. Ensure the alias exists before importing modules that may use it.
import numpy as np
for _old, _new in [('float', float), ('int', int), ('bool', bool), ('complex', complex)]:
